  ...
  group('RegisterCommand', () {
    ...
    group('Sucesso', () {
      test('deve retornar Right com AuthUser quando registro bem-sucedido', () async {
        // Arrange
        when(() => mockAuthService.register(testName, testEmail, testPassword))
      ...
      test('deve criar usuário com nome composto', () async {
        ...
        when(() => mockAuthService.register(compoundName, testEmail, testPassword))
      ...
      test('deve criar usuário com senha forte', () async {
        ...
        when(() => mockAuthService.register(testName, testEmail, strongPassword))
            .thenAnswer((_) async => right(testUser));
      ...
      test('deve aceitar email com subdomínio', () async {
        ...
        when(() => mockAuthService.register(testName, complexEmail, testPassword))
    ...
    group('Falhas de Validação', () {
      test('deve retornar Left com BusinessFailure quando nome vazio', () async {
        // Arrange
        when(() => mockAuthService.register('', testEmail, testPassword))
      ...
      test('deve retornar Left com BusinessFailure quando email vazio', () async {
        // Arrange
        when(() => mockAuthService.register(testName, '', testPassword))
      ...
      test('deve retornar Left com BusinessFailure quando password vazio', () async {
        // Arrange
        when(() => mockAuthService.register(testName, testEmail, ''))
      ...
      test('deve retornar Left com BusinessFailure quando email inválido', () async {
        ...
        when(() => mockAuthService.register(testName, invalidEmail, testPassword))
      ...
      test('deve retornar Left com BusinessFailure quando senha fraca', () async {
        ...
        when(() => mockAuthService.register(testName, testEmail, weakPassword))
      ...
      test('deve retornar Left com BusinessFailure quando senha menor que 6 caracteres', () async {
        ...
        when(() => mockAuthService.register(testName, testEmail, shortPassword))
      ...
      test('deve retornar Left com BusinessFailure quando nome muito curto', () async {
        // Arrange
        const shortName = 'A';
        when(() => mockAuthService.register(shortName, testEmail, testPassword))
    ...
    group('Falhas de Autenticação', () {
      test('deve retornar Left com AuthFailure quando email já cadastrado', () async {
        // Arrange
        when(() => mockAuthService.register(testName, testEmail, testPassword))
            .thenAnswer((_) async => left(AuthFailure('Email já cadastrado')));
      ...
      test('deve retornar Left com AuthFailure quando domínio email bloqueado', () async {
        ...
        when(() => mockAuthService.register(testName, blockedEmail, testPassword))
            .thenAnswer((_) async => left(AuthFailure('Domínio de email não autorizado')));
      ...
      test('deve retornar Left com AuthFailure quando muitas tentativas de registro', () async {
        // Arrange
        when(() => mockAuthService.register(testName, testEmail, testPassword))
            .thenAnswer((_) async => left(AuthFailure('Muitas tentativas, tente novamente mais tarde')));
    ...
    group('Edge Cases', () {
      test('deve lidar com caracteres especiais no nome', () async {
        ...
        when(() => mockAuthService.register(nameWithSpecialChars, testEmail, testPassword))
      ...
      test('deve lidar com email com caracteres especiais válidos', () async {
        ...
        when(() => mockAuthService.register(testName, specialEmail, testPassword))
      ...
      test('deve permitir múltiplos registros sequenciais', () async {
        ...
        when(() => mockAuthService.register('User One', 'user1@test.com', 'pass1'))
            .thenAnswer((_) async => right(user1));
        when(() => mockAuthService.register('User Two', 'user2@test.com', 'pass2'))
